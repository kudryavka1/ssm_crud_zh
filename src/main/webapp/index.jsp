...
//1.页面加载完成后。直接发送ajax请求，得到分页数据
    ...
    function validate_add_form(){
        ...
        if(!regName.test(empName)){
            //清空这个元素之前的样式
            show_validate_msg("#empName_add_input","error","用户名4-10个字符");
